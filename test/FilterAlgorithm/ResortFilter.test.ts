...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - Simple [${i}/10] - All Data`, () => {
...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - Medium [${i}/10] - All Data`, () => {
...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - HC [${i}/10] - All Data`, () => {
...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - Simple [${i}/10] - Valid Data`, () => {
    const number = RandomizeInRange(ResortAlias.size);
...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - Medium [${i}/10] - Valid Data`, () => {
    const randArray = Array(ResortAlias.size - 4)
      .fill(0)
      .map((__) => {
        return RandomizeInRange(ResortAlias.size);
...
for (let i = 0; i < 10; ++i) {
  test(`Resort Filter Test - HC [${i}/10] - Valid Data`, () => {
    const randArray = Array(ResortAlias.size - 2)
      .fill(0)
      .map((__) => {
        return RandomizeInRange(ResortAlias.size);
